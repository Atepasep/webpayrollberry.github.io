...
<div class="container-fluid">
	<div class="gbdepan">
		<img src="<?= LOK_FOTO.'undraw_gb.svg' ?>">
		<div class="row">
			<div class="col-sm-12 mt-4" style="line-height: 35px;">
				<div class="font-tebal" style="font-size: 40px; font-weight: 600">PAYROLL MANAGEMENT</div>
				<div style="font-size: 25px; font-family: 'Roboto',sans-serif;">PT. Indoneptune Net Manufacturing</div>
			</div>
		</div>
	</div>
	<div class="row mt-2">
    ...
    <div style="text-align: center; background-color: red;" class="mt-5 hilang">
        ...
        <span class="warnahitam">PT. Indoneptune Net Mfg</span>
    </div>
</div>
<!-- /.container-fluid -->
