        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              <img src="<?= base_url().'assets/' ?>images/logo.png" alt="Logo" class="tm-site-logo">
...
<!--         <div class="tm-lights-container">
        ...
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header" style="color: black"><img src="<?= base_url().'assets/' ?>images/header-line.png" alt="Line" class="tm-header-line">&nbsp;Welcome To&nbsp;&nbsp;<img src="<?= base_url().'assets/' ?>images/header-line.png" alt="Line" class="tm-header-line"></h2>
    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 tm-welcome-img-container">
            <div class="inline-block shadow-img">
              <img src="<?= base_url().'assets/' ?>images/1.jpg" alt="Image" class="img-circle img-thumbnail">  
            </div>              
          </div>            
        </section>          
        ...
        <section class="tm-section row">
          <div class="col-lg-12 tm-section-header-container">
            <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="<?= base_url().'assets/' ?>images/logo.png" alt="Logo" class="tm-site-logo"> Today's Special</h2>
            <div class="tm-hr-container"><hr class="tm-hr"></div>
          </div>          
          <div class="col-lg-12 tm-special-container margin-top-60">
            <div class="tm-special-container-left"> <!-- left -->
              <div class="tm-special-item">
                <div class="tm-special-img-container">
                  <img src="<?= base_url().'assets/' ?>images/special-1.jpg" alt="Special" class="tm-special-img img-responsive">  
                  <a href="#">
            ...
            <div class="tm-special-container-right"> <!-- right -->
              <div>
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="<?= base_url().'assets/' ?>images/special-2.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
              ...
              <div class="tm-special-container-lower">
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="<?= base_url().'assets/' ?>images/special-3.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
                ...
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="<?= base_url().'assets/' ?>images/special-4.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
                        <p>Quisque rutrum.</p>
                      </div>
